        ...
        <div class="container py-md-5 py-sm-4">
            <div class="row">
                <div class="col-lg-6 left-wthree-img mb-lg-0 mb-md-5 mb-4">
                    <img class="img-fluid img-responsive" src="assets/images/veterinarian-taking-care-pet-dog.jpg" alt=" ">
                </div>
                <div class="col-lg-6 about-right-faq align-self position-relative pl-lg-5">
                    <h6 class="left-text-design">Petverse </h6>
                    <h3 class="title-style mb-2 pl-4">Awesome Care
                    </h3>
            ...
            <div class="row m-auto" style="max-width:1000px">
                <div class="col-md-6">
                    <div class="skills-bars">
                        ...
                        <div class="progress-info">
                            <h6 class="progress-tittle">Others</h6>
                            <div class="progress">
